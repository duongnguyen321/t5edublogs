...
Chi tiết setup phụ thuộc ngôn ngữ và browser, vì vậy không nên coi một snippet JavaScript là contract chung cho Java, Python, C# hoặc Ruby. Hãy bắt đầu bằng trang [Selenium WebDriver BiDi](https://www. selenium.

dev/documentation/webdriver/bidi/) và kiểm tra phần enabling BiDi của binding đang dùng.
